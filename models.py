...
class Usuario(Base):
    ...
    # Campo manual editável pelo usuário.
    estilo_descricao = Column(Text, default="")

    # Campos novos: aprendizado contínuo com base em feedbacks.
    perfil_aprendizado_ia = Column(Text, default="")
    preferencias_extraidas = Column(Text, default="{}")
    ultima_atualizacao_perfil = Column(DateTime, nullable=True)
